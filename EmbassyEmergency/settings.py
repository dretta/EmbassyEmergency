"""
Django settings for EmbassyEmergency project.
...
SECRET_KEY = 'ahp)5b^re7p-ntv3gbyp28%!j42$k+q*vi%rvg38nl&*=wej+r'
...
ROOT_URLCONF = 'EmbassyEmergency.urls'
...
DATABASES = {  
    'default': {
        ...
        'NAME': 'EE',                      # Or path to database file if using sqlite3.
